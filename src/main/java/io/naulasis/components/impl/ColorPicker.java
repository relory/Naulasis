...
public class ColorPicker extends Component {
    ...
    /**
     * A largura (X) é usada no “botão” (fechado) e no painel expandido.
     * A altura (Y) corresponde ao modo “fechado”; o painel expandido adiciona altura extra.
     */
    ...
    private void drawColorPanel(ImDrawList drawList, float x, float y, float totalWidth, float animHeight, float panelAlpha) {
        ...
        float colorAreaVerticalOffset = 15f;
        ImVec2 colorAreaMin = new ImVec2(baseX, hueBarMax.y + spacing + colorAreaVerticalOffset);
